...
WinkPlatform.prototype = {
  reloadData: function(callback) {
    ...
    var that = this;
    WinkJS.user().devices(function(devices) {
...
function WinkAccessory(log, device, type, typeId) {
  ...
  this.control = WinkJS.device_group(this.deviceGroup).device_id(this.deviceId);
...
function WinkLightAccessory(log, device) {
  ...
  that.device = device;
  that.deviceControl = model.light_bulbs(device, WinkJS);
